<style>
  ...
  #_form_23_ ._submit.processing::before {
    ...
    border-radius: 50%;
    background-image: linear-gradient(#b5e683, #b5e683), conic-gradient(#b5e683, #fff);
    ...
    var form_submit = function(e) {
      ...
      if (validate_form()) {
        ...
        async function submitForm() {
          ...
          const response = await fetch('https://irecusa.activehosted.com/proc.php?jsonp=true', {
            headers: {
        ...
        if (formSupportsPost) {
          ...
          _load_script('https://irecusa.activehosted.com/proc.php?' + serialized + '&jsonp=true', null, true);
        }
      }
      return false;
    };
