  ...
  <div class="connect-now__main">
    <div id="startOfResults" class="results">
      ...
      <div class="results__meta">
        ...
        <h2 id="orgsInMapArea">Find Opportunities for Employment, Training, and Partnership</h2>
        <div class="connect-now__header">
          ...
          <div class="filters">
            ...
            <div class="more-filters">
              <div class="tags">
                <sl-dropdown class="opportunity__dropdown" placement="bottom-center" distance="10">
                  <button class="opportunity__trigger opportunity__trigger--tags" slot="trigger" caret>Tags
                    <img src="/wp-content/plugins/irec-green-connect/public/img/caret-down-solid.svg" alt="" /> </button>
                  </button>
            ...
            <form class="search">
              ...
              <div class="search__icon"><img src="/wp-content/plugins/irec-green-connect/public/img/mag-image-gray.svg" alt="submit search"></div>
            </form>
          </div>
        </div>
