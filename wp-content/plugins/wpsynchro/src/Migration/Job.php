...
class Job
{
    ...
    public $db_response_size_wanted_default = 250000;   // Default response size we go with
    public $db_response_size_wanted_max = 5000000;      // Can max scale to X mb, to prevent all sorts of trouble with memory and other stuff
