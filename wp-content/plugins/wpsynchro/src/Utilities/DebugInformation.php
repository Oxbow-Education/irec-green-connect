...
class DebugInformation
{
    ...
    private function populate()
    {
        ...
        $this->data_to_show['WP Synchro PRO'] = (\WPSynchro\Utilities\CommonFunctions::isPremiumVersion() ? 'yes' : 'no');
        if (\WPSynchro\Utilities\CommonFunctions::isPremiumVersion()) {
            $this->data_to_show['WP Synchro PRO validated'] = ($licensing->verifyLicense() ? 'yes' : 'no');
            $this->data_to_show['WP Synchro license data'] = $licensing->getLicenseDetails();
        }
